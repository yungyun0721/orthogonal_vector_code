function [model_settings, obs_settings, da_settings] = settings()
    %% model_settings
    ...
    da_settings.etkf.analyzer.mci_factor = 1.8;%1.15;%1.25 (all obs 36hr)  %covarience inflation
